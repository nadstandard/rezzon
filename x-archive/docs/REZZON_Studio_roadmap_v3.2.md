# REZZON Studio – Roadmapa implementacji v3.2

**Status:** v0.4.0 (Faza 4 ukończona)
**Data:** 2025-12-29
...
## 🧪 TEST CHECKPOINT #2 — CRUD

**Zakres:** Operacje CRUD  
**Cel:** Sprawdzić czy edycja danych działa poprawnie

**Checklistka:**
- [ ] Inline rename działa (double-click, edit, Enter/Esc)
- [ ] Walidacja: pusty, duplikat, "/" w nazwie
- [ ] Bulk rename z Match/Replace + preview
- [ ] Bulk rename z regex
- [ ] Delete z potwierdzeniem
- [ ] Info o broken aliasach przy delete
- [ ] Duplicate folder tworzy kopię z sufiksem
- [ ] Toolbar i Selection Bar działają
...
**Test Checkpoint #2** → potem **Faza 5: Aliasy**
