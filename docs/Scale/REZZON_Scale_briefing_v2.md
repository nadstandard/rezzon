...
## 12. Warstwy output (lista otwarta)

### Obecne w arkuszu:

| Warstwa | Opis |
|---------|------|
| `grid/column/` | Bazowe szerokości kolumn |
| `grid/container/` | Column + warianty responsywne |
| `grid/photo/width/` | Szerokości dla zdjęć + responsywność |
| `grid/photo/height/` | Wysokości per ratio family + responsywność |
...
2. ☐ HTML mockup Grid editora
3. ☐ Briefing sekcji Spacing
4. ☐ Briefing sekcji Typography
5. ☐ Briefing sekcji Radius
6. ☐ React implementacja
