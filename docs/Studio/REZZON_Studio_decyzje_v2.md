...
Notatki z wywiadu z 2025-12-18 oraz sesji projektowania makiet (2025-12).
Uzupełnienie do głównej specyfikacji wymagań.
...
## 11. Decyzje UI/UX z sesji projektowania makiet (2025-12)

### Styl wizualny

**Decyzja:** Dark mode, inspiracja Figma Variables.

- Tło aplikacji: `#1a1a1a`
- Tło powierzchni (sidebar, header): `#242424`
- Tło elevated (hover, karty): `#2e2e2e`
- Border: `#3a3a3a`
- Tekst główny: `#f5f5f5`
- Tekst secondary: `#a1a1a1`
- Tekst muted: `#666666`
- Akcent: fioletowy `#6366f1`
- Success/internal: zielony `#22c55e`
- Warning/external: pomarańczowy `#f59e0b`
- Error/broken: czerwony `#ef4444`

**Ikony:** Lucide (SVG inline, stroke-based) – Phosphor Bold odrzucony jako zbyt ciężki wizualnie.
...
### Sidebar – 3 sekcje (każda collapsible)
...
3. **Folders** – drzewo folderów zsynchronizowane z tabelą
   - Hierarchia z wcięciami (Edit → Wave, Components, System)
   - Checkboxy zsynchronizowane z tabelą (dla bulk operations)
   - Rozwijanie/zwijanie zsynchronizowane z tabelą (real-time)

### Tabela zmiennych

**Decyzja:** Hierarchiczna struktura z checkboxami.

Kolumny:
- Checkbox (do bulk operations)
- Name (zmienna + type badge)
- Mode columns (Alfa, 1920, 1366, 768, 390... max 10, potem horyzontalny scroll)
...
### Wyświetlanie aliasów w wartościach
...
**Decyzja:** Toggle przyciskiem w toolbarze (`sidebar-simple` icon), pozostaje aktywny do ręcznego zamknięcia (X).
...
**Decyzja:** Zawsze widoczny na dole, zawiera:
...
## 12. Wersjonowanie makiet

**Decyzja:** Semantic versioning dla makiet HTML.

- `v0.1.x` – fixy i drobne poprawki
- `v0.2.0` – nowy widok lub większa funkcjonalność
- `v1.0.0` – kompletna makieta gotowa do implementacji

Aktualna wersja bazowa: `v0.1.0` (widok Variables)
